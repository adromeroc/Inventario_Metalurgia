                ...
                <form>
                    <div className="form-group row">
                        ...
                        <div className="col-sm-10">
                            <input type="text" className="form-control" id="inputIdProducto" placeholder="Identificador producto" />
                        </div>
                    </div>
                    <div className="form-group row">
                        <label htmlFor="inputNombre" className="col-sm-2 col-form-label">Nombre</label>
                        <div className="col-sm-10">
                            <input type="text" className="form-control" id="inputNombre" placeholder="Nombre del producto" />
                        </div>
                    </div>
                    <div className="form-group row">
                        <label htmlFor="inputUnidadMedida" className="col-sm-2 col-form-label">Unidad Medida</label>
                        <div className="col-sm-10">
                            <select id="inputUnidadMedida" class="form-control">
                    ...
                    <div className="form-group row">
                        ...
                        <div className="col-sm-10">
                            <input type="number" className="form-control" id="inputValor" placeholder="Valor del producto" />
                        </div>
                    </div>
                    <div className="form-group row">
                        <div className="col-sm-10">
